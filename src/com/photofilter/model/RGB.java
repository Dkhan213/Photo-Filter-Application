...
public final class RGB {
    ...
    // since there are no references passed to this constructor - defensive copying is not required
     ...
     */
//    public void toGreyScale( ){  // return type changed from void to an object
    public RGB toGreyScale( ) {
        int avg = (red + green + blue) / 3;

        // Since marking the member data as final, we can no longer change it
        // we need to return a new object with the values we want to change
